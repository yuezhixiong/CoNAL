...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'resnet50conv4n']
...
def resnet50conv4n(pretrained=False, progress=True, conv4_num=6, **kwargs):
    return _resnet('resnet50', Bottleneck, [3, 4, conv4_num, 3], pretrained, progress,
                   **kwargs)


class ResnetDilated(nn.Module):
    def __init__(self, orig_resnet_name, dilate_scale=8):
        super(ResnetDilated, self).__init__()
        from functools import partial

        orig_resnet = eval(orig_resnet_name)(pretrained=True)
        if dilate_scale == 8:
